...
router.get('/professionals/available', authMiddleware, adminController.getAvailableProfessionals);
router.get('/professionals', authMiddleware, adminController.getAllProfessionals);
